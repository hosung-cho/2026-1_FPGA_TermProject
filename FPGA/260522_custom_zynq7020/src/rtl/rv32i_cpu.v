...
module maindec(input  [6:0] opcode,
  ...
  begin
    case(opcode)
      ...
      `OP_CUSTOM0:	controls <= 10'b0010_0000_01; // CNN Custom (RegWrite=1, is_custom=1)
...
module aludec(input      [6:0] opcode,
  ...
  always @(*) begin
    ...
    case(opcode)
      ...
      `OP_CUSTOM0:   // CNN Custom Instructions
      begin
      	ALUcontrol <= 5'b00000;  // ALU unused but set default
      	case(funct7)
...
module datapath(input         clk, reset,
  ...
  regfile i_regfile(
	...
	begin
		...
		else if (is_custom)	rd_data[31:0] = cfu_result;
