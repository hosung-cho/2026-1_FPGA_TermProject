...
set bit_file [file join $script_dir "build_ps_bd_impl" "rv32i_lenet_ps_bd.bit"]
...
puts "RV32I_PROGRAM_OK=1"
puts "RV32I_PROGRAMMED_DEVICE=$zynq_device"
puts "RV32I_PROGRAMMED_BIT=$bit_file"
