# ==========================================
# LeNet-5 SW Only - Vivado Tcl Simulation
# ==========================================
...
# RTL 소스 (original RV32I RTL로 변경)
read_verilog [glob ../../../FPGA/260522_original_zynq7020/src/rtl/*.v]
# 테스트벤치
read_verilog ../lenet5_sw_tb.v
...
set_property top lenet5_sw_tb [get_filesets sim_1]
