...
// ==============================================================
#ifndef __CNN_ALU_Top_mac_mdEe__HH__
#define __CNN_ALU_Top_mac_mdEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(CNN_ALU_Top_mac_mdEe) {
    ...
    SC_CTOR(CNN_ALU_Top_mac_mdEe):  simcore_mac_0_U ("simcore_mac_0_U") {
